...
| Skill | When to use |
| --- | --- |
| [Senshac Agent Principles](.agents/skills/senshac-agent-principles/SKILL.md) | Every focused change; it defines the portable working rules. |
...
| [Security Review](.agents/skills/security-review/SKILL.md) | Any change involving credentials, access, secrets, or security-sensitive operations. |
